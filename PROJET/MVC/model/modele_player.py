...
serialized_player_1 = dict(name=player_1.name, f_name=player_1.f_name, age=player_1.age, birthdate=player_1.birthdate,
                           gender=player_1.gender, ranking=player_1.ranking, score=player_1.score)
serialized_player_2 = dict(name=player_2.name, f_name=player_2.f_name, age=player_2.age, birthdate=player_2.birthdate,
                           gender=player_2.gender, ranking=player_2.ranking, score=player_2.score)
serialized_player_3 = dict(name=player_3.name, f_name=player_3.f_name, age=player_3.age, birthdate=player_3.birthdate,
                           gender=player_3.gender, ranking=player_3.ranking, score=player_3.score)
serialized_player_4 = dict(name=player_4.name, f_name=player_4.f_name, age=player_4.age, birthdate=player_4.birthdate,
                           gender=player_4.gender, ranking=player_4.ranking, score=player_4.score)
serialized_player_5 = dict(name=player_5.name, f_name=player_5.f_name, age=player_5.age, birthdate=player_5.birthdate,
                           gender=player_5.gender, ranking=player_5.ranking, score=player_5.score)
serialized_player_6 = dict(name=player_6.name, f_name=player_6.f_name, age=player_6.age, birthdate=player_6.birthdate,
                           gender=player_6.gender, ranking=player_6.ranking, score=player_6.score)
serialized_player_7 = dict(name=player_7.name, f_name=player_7.f_name, age=player_7.age, birthdate=player_7.birthdate,
                           gender=player_7.gender, ranking=player_7.ranking, score=player_7.score)
serialized_player_8 = dict(name=player_8.name, f_name=player_8.f_name, age=player_8.age, birthdate=player_8.birthdate,
                           gender=player_8.gender, ranking=player_8.ranking, score=player_8.score)

serialized_players = (serialized_player_1, serialized_player_2, serialized_player_3, serialized_player_4,
                      serialized_player_5, serialized_player_6, serialized_player_7, serialized_player_8)
